...
STRUCT2((Tree T), (Union (T None (Tree T))), (Union (None (Tree T))), :child, :nextSibling)
(defun (None) () ((cast None) 0))
(defun ((Tree T) X Y) (child rest) ((Tree T) ((Union (T None (Tree T))) child)
					   ((Union (None (Tree T))) rest)))

(defun (print None) (n) (print "()"))
...
(defun (St X Y) (x y) ((Tree String) x y))

// (print (St (St "ConsCell" (St "87" (None)))  (St "goodby" (None))))
